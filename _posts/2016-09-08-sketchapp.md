...
관리하고 있었습니다. 아이콘 소스들은 일러스트레이터에서 벡터 방식으로
제작하고 최종 화면은 포토샵에서 비트맵 방식으로 조립해서 저장하는
형식이었습니다. 그리고 완료된 디자인은 구글 문서 프리젠테이션 툴로
...
써보지 않고 판단하기엔 정보도 부족했기에 변방으로 내몰리면 힘든 만큼
많은 경험치가 따를 것으로 예상했습니다. 그리고 기회라고 생각했습니다.
이전 작업 중 발생하는 문제는 최대한 빨리 이슈화해서 문제를 해결하기로
하고 스케치로의 이전 작업을 시작했습니다.
